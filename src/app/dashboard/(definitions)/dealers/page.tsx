...
export default function Dealers() {
    ...
    const onSubmitUpdate: SubmitHandler<IFormInput> = async (data) => {
        ...
        await fetch(`/api/dealer/${data.id}`, {
            method: "PUT",
            body: JSON.stringify(data),
            headers: { "Content-Type": "application/json" },
        })
    ...
    const renderCell = React.useCallback(
        (dealer: Dealer, columnKey: React.Key) => {
                ...
                case "actions":
                    return (
                        <div className="relative flex justify-start items-center gap-2">
                            <Tooltip key={dealer.id} content="Düzenle">
                            ...
                            <Tooltip key={dealer.id} content="Sil">
    ...
    const { data, error, mutate } = useSWR("/api/dealer");
